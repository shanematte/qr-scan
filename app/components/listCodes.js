...
import AllCodesTime from './allCodesForTime'
...
class ListCodes extends Component {
	...
	render(){
		...
		const userContent = <AllCodesTime navigator={this.props.navigation}/>
...
export default connect(mapStateToProps, dispatchToProps)(ListCodes)